...
public class QueryPlanTest {
    ...
    public void testJoins() {
        ...
        JoinInfo join = new JoinInfo(com.jsdiff.xlsql.engine.model.JoinType.INNER, table2, condition);
        
        plan.addJoin(join);
        
        assertEquals(1, plan.getJoins().size());
        assertEquals(com.jsdiff.xlsql.engine.model.JoinType.INNER, plan.getJoins().get(0).getType());
    }
    ...
    public void testSetJoins() {
        ...
        TableInfo table2 = new TableInfo("test2", "Sheet1", "t2");
        JoinCondition condition = new JoinCondition("t1.id", "t2.id", "=");
        joins.add(new JoinInfo(com.jsdiff.xlsql.engine.model.JoinType.LEFT, table2, condition));
        
        plan.setJoins(joins);
        
        assertEquals(1, plan.getJoins().size());
        assertEquals(com.jsdiff.xlsql.engine.model.JoinType.LEFT, plan.getJoins().get(0).getType());
    }
    ...
    public void testComplexQueryPlan() {
        ...
        JoinCondition condition = new JoinCondition("t1.id", "t2.id", "=");
        JoinInfo join = new JoinInfo(com.jsdiff.xlsql.engine.model.JoinType.INNER, joinTable, condition);
        plan.addJoin(join);
