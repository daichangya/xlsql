...
/**
 * H2EngineTestBase - H2引擎测试基类
 * 
 * <p>提供所有H2引擎测试的公共setup/teardown逻辑。
 * 所有H2引擎相关的测试类应该继承此类。</p>
 * 
 * @author daichangya
 */
public abstract class H2EngineTestBase {
    ...
    public void setUpBase() throws Exception {
        ...
        // 使用xlDriver连接，将自动使用xlConnectionH2
        // 连接URL指向database目录
