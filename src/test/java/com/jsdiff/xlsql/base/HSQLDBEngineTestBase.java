...
/**
 * HSQLDBEngineTestBase - HSQLDB引擎测试基类
 * 
 * <p>提供所有HSQLDB引擎测试的公共setup/teardown逻辑。
 * 所有HSQLDB引擎相关的测试类应该继承此类。</p>
 * 
 * @author daichangya
 */
public abstract class HSQLDBEngineTestBase {
