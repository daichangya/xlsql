...
public interface Constants {
    ...
    public static final String DRIVER = "io.github.daichangya.xlsql.jdbc.xlDriver";

    public static final String DRIVER_NAME = "XLSQL Excel JDBC Driver";
    public static final String DRIVER_RELEASE = "beta:Y8";
    public static final String DRIVER_CLASS = "io.github.daichangya.xlsql.jdbc.jdbcDriverXls";
